...
exports.SWOT_ABUSED_DOMAINS = new Set([
    ...
    "ks.ac.kr",
    "continental.edu.pe",
    "sman19bandung.sch.id",
    "365.mokpo.ac.kr",
    "mokpo.ac.kr",
    "sman1kendal.sch.id",
    "my.students.amrita.edu",
    "amrita.edu",
    "aluno.uema.br",
    "uema.br",
    "athonedu.com.br",
    ...
    "usfa.edu.bo",
    "futa.edu.ng",
    "technikumcyfrowe.onmicrosoft.com",
    "alumno.uaemex.mx",
    "stu.kln.ac.lk",
    ...
    "studuniroma3.onmicrosoft.com",
    "nguyensieuschool.edu.vn",
    "myiuc.com",
    "student.werribeesc.vic.edu.au",
    "werribeesc.vic.edu.au",
    "khwopa.edu.np",
    "adm.emi.edu.bo",
    "udemex.edu.mx",
    "iugaza.edu.ps",
    "students.lrsd.org",
    "viu.edu.vn",
    "hochiminh.itrithuc.vn",
    "ipiaget.pt",
    "student.green.ac.bd",
    "rmutsv.ac.th",
    "livenau.netmarconi-galletti.it",
    "sumare.edu.br",
    "eaeat-academy.edu.eg",
    "hpk.edu.ua",
    "eufh-mail.de",
    "inacapmail.cl",
    "mail.utoronto.ca",
...
//# sourceMappingURL=swot_abused_domains.js.map