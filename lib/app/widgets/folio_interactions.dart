...
/// Estado de error canónico para una página o sección completa (ocupa el
/// espacio disponible y entra con una animación de fade+slide). Para errores
/// inline dentro de un formulario o una lista, donde una animación de entrada
/// sería ruido, usa [FolioErrorCard] en su lugar.
