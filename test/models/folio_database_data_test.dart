...
void main() {
  group('FolioDatabaseData', () {
    ...
    test('formula concat and rollup count/sum resolve', () {
      ...
      final rollupCount = FolioDbProperty(
        id: 'p_roll_count',
        name: 'Roll Count',
      ...
      final rollupSum = FolioDbProperty(
        id: 'p_roll_sum',
        name: 'Roll Sum',
        type: FolioDbPropertyType.rollup,
      )
      ...
      db.properties = [...db.properties, numProp, relProp, formulaProp, rollupCount, rollupSum];
      db.rows = [
        FolioDbRow(id: 'r1', values: {title.id: 'Row 1', numProp.id: 10}),
        FolioDbRow(id: 'r2', values: {title.id: 'Row 2', numProp.id: 15}),
        FolioDbRow(
          id: 'r3',
          values: {title.id: 'Host', relProp.id: ['r1', 'r2']},
        ),
      ];
    ...
    test('formula if/math/date helpers and rollup avg/min/max/percent_checked', () {
      final db = FolioDatabaseData.empty();
      final title = db.properties.first;
      ...
      final max = FolioDbProperty(
        ...
        ..rollupTargetPropertyId = amount.id
        ..rollupOperation = 'max';
      final percentChecked = FolioDbProperty(
        id: 'p_pct',
        name: 'PercentChecked',
        type: FolioDbPropertyType.rollup,
      )
      ...
      db.rows = [
        ...
        FolioDbRow(
          id: 'r3',
          values: {title.id: 'Host', rel.id: ['r1', 'r2']},
        ),
      ];
